...
document.write("<center><table><tr><td align=center><p class='heading'>NAVIOS INIMIGOS</p></td><p>  " +
    "<td align=center><p class='heading'>NAVIOS ALIADOS</p></td></tr><tr><td>");
showGrid(true);
document.write("<p><p><p></td></td><td>");
showGrid(false);
document.write("<p></td></td></tr></table></center>");
updateStatus();
