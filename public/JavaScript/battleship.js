...
function imagePreload() {
  ...
  for (i=0;i<ids.length;++i) {
    var img = new Image, name = "public/images/batt"+ids[i]+".gif";
    img.src = name;
    preloaded[i] = img;
  }
  window.status = "";
...
function showGrid(ispc) {
  ...
  for (y=0;y<gridy;++y) {
    for (x=0;x<gridx;++x) {
      if ( ispc )
      document.write ('<a href="javascript:gridClick('+y+','+x+');"><img name="pc'+y+'_'+x+'" src="public/images/batt100.gif" width=16 height=16></a>');
      else
...
document.write("<center><table><tr><td align=center><p class='heading'>NAVIOS INIMIGOS</p></td>"+
